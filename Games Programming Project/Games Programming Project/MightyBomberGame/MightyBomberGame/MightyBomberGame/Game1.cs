...
namespace MightyBomberGame
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        /// <summary>
        /// Allows the game to perform any initialisation it needs to before starting to run.
        ...
        protected override void Initialize()
        {
            ...
            ScreenManager.Instance.Initalize();
            ScreenManager.Instance.Dimentions = new Vector2(1920, 1080);
